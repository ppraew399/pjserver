  ...
  <div class="container">
    ...
    <div class="blog-header">
      ...
      <div class="create-blog">
        <button class="btn btn-success btn-sm" v-on:click="navigateTo('/blog/create')">สร้าง รายชื่อชมรม</button>
        <strong>จํานวน ชมรม:</strong>
        {{results.length}}
      </div>
    ...
    <transition-group name="fade">
      <div v-for="blog in blogs" v-bind:key="blog.id" class="blog-list">
        ...
        <div class="blog-info">
          ...
          <p>
            <button class="btn btn-sm btn-info" v-on:click="navigateTo('/blog/'+ blog.id)">รายละเอียด</button>
            <button class="btn btn-sm btn-warning" v-on:click="navigateTo('/blog/edit/'+ blog.id)">แก้ไข</button>
