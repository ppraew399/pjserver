        ...
        <div class="comments-wrapper">
            <div class="comment-form-wrapper">
                ...
                <form v-on:submit.prevent="sendComment">
                    ...
                    <p v-if="user == null">เข้าสู่ระบบ / สมัครสมาชิก สำหรับแสดงความคิดเห็น</p>
                    <p v-else ><button type="submit" class="btn btn-primary"><i class="fas fa-comment"></i> แสดงความคิดเห็น</button></p>
                </form>
            </div>
