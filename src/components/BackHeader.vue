...
<div class="navbar navbar-inverse navbar-fixed-top">
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navcol-1">
            <ul class="nav navbar-nav navbar-right">
                <li><router-link :to="{name: 'blogs'}" >รายชื่อ</router-link></li>
           
                <li><router-link :to="{name: 'users'}" >ผู้ใช้งาน</router-link></li>
                <li><router-link :to="{name: 'comments'}" >ความคิดเห็น</router-link></li>

                <li v-if="!isUserLoggedIn"><router-link :to="{name: 'login'}" >เข้าสุ่ระบบ</router-link></li>
    ...
    <ul class="nav">
    <li><router-link :to="{name: 'blogs'}" >รายชื่อ</router-link></li>
    <li><router-link :to="{name: 'users'}" >ผู้ใ้งาน</router-link></li>
    <li><router-link :to="{name: 'comments'}" >ความคิดเห็น</router-link></li>
    <li><router-link :to="{name: 'login'}" >เข้าสู่ระบบ</router-link></li>
    <li><a href="#" v-on:click="logout">ออกจากระบบ</a></li>
    </ul>
