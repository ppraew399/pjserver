    ...
    <div class="container">
        ...
        <div class="blog-header">
            ...
            <div class="create-blog">
                <h4>จํานวน ความคิดเห็น {{comments.length}}</h4>
            </div>
        </div>
        <div v-for="comment in comments" v-bind:key="comment.id" class="blog-list">
            ...
            <p>
                <button class="btn btn-sm btn-info" v-on:click="navigateTo('/blog/'+ comment.blogId)">ดูรายละเอียดความคิดเห็น</button> 
